  ...
  return (
    <>
      <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
        <Toaster />
        <button
          className="w-12 h-12 absolute right-[5vw]  top-[10%]  "
        ...
        <div className="border-grey lg:border lg:pl-8">
          ...
          <input
            type="text"
            value={title}
            placeholder="Blog Tite"
            className="input-box pl-4 bg-slate-200  "
            onChange={handelBlogTilteChange}
          />
          ...
          <div className="flex justify-between items-center gap-2 mb-2 mt-9">
          ...
          <p className="mt-1 mb-4 text-right">
            {tageLimit - category.length} tags left
          </p>
          <button onClick={submitdata} className="px-8 text-sm btn-dark">
            publish
          </button>
        </div>
      </section>
